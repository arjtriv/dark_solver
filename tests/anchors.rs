...
#[path = "anchors/startup_rpc_probe_validated_config.rs"]
pub mod startup_rpc_probe_validated_config;

#[path = "anchors/discovery_decode_fail_closed.rs"]
pub mod discovery_decode_fail_closed;
